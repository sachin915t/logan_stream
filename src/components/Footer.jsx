...
export default function Footer() {
  return (
    ...
    >
      ...
      {/* Title - changed from <p> to <h3> for semantic heading */}
      <motion.h3
      ...
      {/* Tagline - changed from <p> to <div> since it contains block elements */}
      <motion.div
        className="text-xs text-gray-500 tracking-wider flex flex-col items-center gap-2"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
        transition={{ delay: 0.5, duration: 1 }}
      >
        <strong>Streaming Across the Grand Line</strong>
